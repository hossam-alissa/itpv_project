...
class VlcPlayerWithControlsState extends State<VlcPlayerWithControls>
  ...
  void listener() async {
    try {
      ...
      print("===== Done Listener VlcPlayerWithControls =====");
    } catch (error) {
      print("===== error Listener VlcPlayerWithControls =====");
      print(error);
    }
  }
  ...
  //
  //     print("===== Done _createCameraImage VlcPlayerWithControls =====");
  //   } catch (error) {
  //     print("===== error _createCameraImage VlcPlayerWithControls =====");
  //     print(error);
  //   }
  // }
  //
